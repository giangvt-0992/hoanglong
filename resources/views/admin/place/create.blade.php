	...
	<div class="">
		<div class="page-title">
			<div class="title_left">
				<p>Home / Địa điểm / Thêm địa điểm</p>
			</div>
		</div>
				...
				<div class="x_panel">
					...
					<div class="x_content">
						...
						<div class="col-md-8 center-margin">
							<form class="form-horizontal form-label-left" method="POST" action="{{route('admin.place.store')}}">
								@csrf
								<div class="form-group">
									<label>Tên địa điểm</label>
									<input type="text" class="form-control" placeholder="Tên địa điểm" name="name" value="{{old('name')}}" required>
									@if($errors->has('name'))
								...
								<div class="form-group">
									<label>Map URL</label>
									<textarea type="text" class="form-control" placeholder="Link bản đồ" name="map" rows="5" required>{{old('map')}}</textarea>
									@if($errors->has('map'))
