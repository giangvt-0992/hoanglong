    ...
    @include('admin.layout.flash')
		...
		<div class="row">
            ...
            <div class="col-md-8 center-margin">
              <form class="form-horizontal form-label-left" method="POST" action="{{route('admin.district.store')}}">
                @csrf
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Tên quận huyện" name="name" value="{{old('name')}}">
                  @if($errors->has('name'))
                  <span class="text-danger">{{$errors->first('name')}}</span>
                  @endif
                </div>
