							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										...
										<a href="{{route('admin.route.inactive', ['route' => $route->id])}}" class="btn btn-dark btn-deactivate" data-page="route" title="Ngưng kích hoạt"><i class="fas fa-ban"></i></a>
										@else
										<a href="{{route('admin.route.active', ['route' => $route->id])}}" class="btn btn-success btn-active" data-page="route" title="Kích hoạt"><i class="fas fa-recycle"></i></a>
										@endif
